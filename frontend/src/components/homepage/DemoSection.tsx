        ...
        <div className="max-w-6xl mx-auto mb-12 sm:mb-16 lg:mb-20">
          ...
          >
            ...
            <motion.div
              ...
              className="hidden sm:block absolute top-6 sm:top-10 left-6 sm:left-10 w-20 sm:w-28 h-20 sm:h-28 border border-border rounded-xl -rotate-12 opacity-30 group-hover:opacity-50 transition-opacity"
            />
            <motion.div
              initial={{ opacity: 0, scale: 0.5 }}
              ...
              className="hidden sm:block absolute bottom-6 sm:bottom-10 right-6 sm:right-10 w-24 sm:w-36 h-24 sm:h-36 border border-border rounded-full opacity-30 group-hover:opacity-50 transition-opacity"
            />
            <motion.div
              ...
              className="hidden sm:block absolute top-1/3 right-8 sm:right-14 w-16 sm:w-20 h-16 sm:h-20 border border-border rotate-45 opacity-30 group-hover:opacity-50 transition-opacity"
            />
          </motion.div>
